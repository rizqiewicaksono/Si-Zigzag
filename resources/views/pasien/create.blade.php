...
<div class="wrapper">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/pasien/create" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <form method="POST" action="/pasien" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-lg-5">
          <h1 class="mb-4 text-dark">Pendaftaran Pasien</h1>



           <div class="form-group">
            <label>Nomor:</label>
            <input type="text" class="form-control" name="nib" readonly value="PSN{{ date('yymd-his') }}">
          </div>
          ...
          <div class="form-group">
            <label>Alamat:</label>
            <input type="text" class="form-control" name="alamat_pasien" placeholder="Masukan Alamat">
          </div>

          <div class="form-group">
            <label>Nama Orangtua:</label>
            <input type="text" class="form-control" name="orangtua_pasien" placeholder="Masukan Nama">
          </div>

          <div class="form-group">
            <label>Nomor HP:</label>
            <input type="number" class="form-control" name="no_hp" placeholder="Masukan Nomor Telepon">
          </div>
