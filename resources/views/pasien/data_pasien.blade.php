              ...
              <div class="content-wrapper">
                ...
                <div class="content-header">
                  <div class="container-fluid">
                    <div class="row mb-2">
                      <div class="col-sm-6">
                        <h1 class="mb-4  text-dark">Data Pasien</h1>

                        <form action="/cari" method="GET" class="mb-4">
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <a  href="/rekap/profil/{{$item->id}}" class="btn btn-info">Detail</a>
                                  <a  href="/periksa/{{$item->id}}" class="btn btn-info">Periksa</a>
                                  <!--  <a href="/rekap/destroy/{{ $item->id }}" class="btn btn-danger">Hapus</a> -->
                                </td>
                              </tr>
                              @endforeach
