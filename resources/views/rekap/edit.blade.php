...
<div class="wrapper">
 ...
 <div class="content-wrapper">
    ...
    @foreach($pasiens as $item)
          <form method="POST" action="/rekap/update/{{$item->id}}" enctype="multipart/form-data">
      ...
      <div class="row">
        <div class="col-lg-5">
          ...
          <div class="form-group">
            <label>Alamat:</label>
            <input type="text" class="form-control" name="alamat_pasien" value="{{$item->alamat_pasien}}" placeholder="Masukan Alamat" >
          </div>

          <div class="form-group">
            <label>Nama Orangtua:</label>
            <input type="text" class="form-control" name="orangtua_pasien" readonly value="{{$item->orangtua_pasien}}" placeholder="Masukan Nama">
          </div>

          <div class="form-group">
            <label>Nomor HP:</label>
            <input type="number" class="form-control" name="no_hp" value="{{$item->no_hp}}" placeholder="Masukan Nomor Telepon">
          </div>

           <div class="box-footer">
            <button type="submit" class="btn btn-primary w-100" value="Simpan Data">Submit</button>
          </div>
